    ...
    if ($ext == 'xlsx') {
        ...
        foreach ($obj->getWorksheetIterator() as $sheet) {
            ...
            for ($i = 2; $i <= $getHighestRow; $i++) {
                ...
                $req = $sheet->getCellByColumnAndRow(3, $i)->getValue();

                $query = "INSERT INTO ivr(userid, username, cdate, req_by) VALUES ('$uid','$username','$date','$req')";
        ...
        echo "<script>
            ...
            window.location.href='insert_ivr.php';
        </script>";
    }
}
